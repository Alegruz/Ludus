...
|-----------|-------|----------|-------|----------|-----------|
| **mimalloc** | ‚≠ê‚≠ê‚≠ê‚≠ê‚≠?| ‚≠ê‚≠ê‚≠ê‚≠ê‚≠?| ‚≠ê‚≠ê‚≠ê‚≠ê‚≠?| ??| Low |
| **jemalloc** | ‚≠ê‚≠ê‚≠ê‚≠ê | ‚≠ê‚≠ê‚≠ê‚≠ê‚≠?| ‚≠ê‚≠ê‚≠ê‚≠ê‚≠?| ?†Ô∏è | Medium |
| **tcmalloc** | ‚≠ê‚≠ê‚≠?| ‚≠ê‚≠ê‚≠?| ‚≠ê‚≠ê‚≠ê‚≠ê | ?†Ô∏è | High |
| **System malloc** | ‚≠ê‚≠ê | ‚≠ê‚≠ê | ?†Ô∏è | N/A | N/A |
...
LudusBuildSettings (INTERFACE)
    ?ú‚??Ä ProjectSanitizersSettings
    ?î‚??Ä mimalloc (MI_OVERRIDE=ON)

Targets using LudusBuildSettings:
    ?ú‚??Ä LudusCore (shared lib)
    ?ú‚??Ä LudusPlatform (shared lib)
    ?î‚??Ä LudusEditor (executable)
```
...
### Phase 3: Subsystem Integration (?îÑ Pending)
...
### Phase 4: Profiling & Optimization (?îÑ Pending)
