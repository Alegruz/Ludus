...
namespace ludus::foundation::core
{
    ...
    public:
        ...
        explicit UniquePtr(ElementType*& ptr) noexcept: mPtr(ptr) { ptr = nullptr; }

        UniquePtr(const UniquePtr&) = delete;
        UniquePtr& operator=(const UniquePtr&) = delete;

        constexpr UniquePtr(UniquePtr&& other) noexcept: mPtr(other.mPtr) { other.mPtr = nullptr; }
        ...
        [[nodiscard]] ElementType* Get() const noexcept { return mPtr; }
        [[nodiscard]] ElementType* Release() noexcept;
        void Reset(ElementType* ptr = nullptr) noexcept;

        [[nodiscard]] ElementType& operator*() const noexcept { return *mPtr; }
        [[nodiscard]] ElementType* operator->() const noexcept { return mPtr; }
    ...
    UniquePtr<ElementType, DeleterType>& UniquePtr<ElementType, DeleterType>::operator=(UniquePtr<OtherType, OtherDeleterType>&& other) noexcept
    {
